...
lint-py:  ## run python linter with ruff
	python -m ruff check daggre
	python -m ruff format --check daggre
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix daggre
	python -m ruff format daggre
...
test-py:  ## run python tests
	python -m pytest -v daggre/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v daggre/tests --cov=daggre --cov-report term-missing --cov-report xml
